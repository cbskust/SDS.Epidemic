# This function converts epidemic data wih infection and removed time to SIR 
#  trajectory data with S(t), I(t), and R(t) at discrete time t
# sellke.data: input data set, must be a form of sellke empidemic 
