# This function generates posterior samples of beta, gamma, and rho 
#using MCMC based on Examce likelihood in subsection 4.1 
# indata: input data set. SIR trajectory data set 
# nrepeat: number of iteration of MCMC 
# prior.a: hyper shape parameter of gamma prior for beta, gamma 
# prior.b: hyper rate parameter of gamma prior for beta, gamma 
