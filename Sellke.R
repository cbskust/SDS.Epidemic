# This function generate synthetic epidemic data using Sellke construciotn 
# in Algorithm 3.1 
# n: number of initial susceptible
# beta, gamma, rho: parmeters, tranmission rate, recovery rate, initial infective ratio
